...
class AbsensiController extends Controller
{
    ...
    public function laporan(Request $request)
    {
        ...
        $pegawaiList = \App\Models\Pegawai::with([
        ...
        $data = $pegawaiList->map(function ($pegawai) use ($jumlahHari, $bulan, $tahun) {
            $absensiByTanggal = $pegawai->absensis->keyBy(function ($item) {
            ...
            for ($hari = 1; $hari <= $jumlahHari; $hari++) {
                $absensi = $absensiByTanggal->get($hari);
                ...
                $harian[] = [
                    ...
                    'status' => $absensi?->status ?? ($isWeekend ? 'libur' : 'tidak hadir'),
